    ...
    .then((userCredential) => {
        ...
        .catch((error) => {
         ...
         // Now proceed with saving additional details to Firestore or other tasks
            ...
            hideLoadingOverlay(); // Hide the loading overlay after form submission
            displaySuccessMessage("Registration successful! Please check your email for verification. Verified? Click here to <a href='login.html' style='color: white;'>Login</a>");
